...
import ru.katishev.Project2Boot.util.PersonValidator;
...
public class PeopleController {
    ...
    public String show(@PathVariable("id") int id, Model model) {
        ...
        model.addAttribute("booksToAdd", booksService.findFreeBooks());
        model.addAttribute("book", new Book());
        List<Book> books = peopleService.getBookForPerson(person);
